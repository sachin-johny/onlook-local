...
export const env = createEnv({
    ...
    server: {
        ...
        ONLOOK_LOCAL_PROJECTS_DIR: z.string().optional(),
        ONLOOK_PTY_PORT: z.string().optional(),
    ...
    runtimeEnv: {
        ...
        ONLOOK_LOCAL_PROJECTS_DIR: process.env.ONLOOK_LOCAL_PROJECTS_DIR,
        ONLOOK_PTY_PORT: process.env.ONLOOK_PTY_PORT,
